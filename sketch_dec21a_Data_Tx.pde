...
//////////////////////////////////////////
char RX_ADDRESS[] = "0013A200416BE243";
//////////////////////////////////////////
...
void loop()
{
  ...
  char shumd[10];
  dtostrf(humd, 2, 2, shumd);
  char spres[8];
  dtostrf(pres, 5, 2, spres);

  sprintf( msn, "Temp: %s, Hum: %s, Pres: %s#", stemp, shumd, spres);
  
  // add frame fields
  //frame.addSensor(SENSOR_STR, stemp);
  //frame.addSensor(SENSOR_STR, shumd);
  //frame.addSensor(SENSOR_STR, spres);
  frame.addSensor(SENSOR_STR, msn);
